                            ...
                            while len(lowP) == 0 or len(highP) == 0:
                                ...
                                if len(lowP) == 0 or len(highP) == 0:
                                    ...
                                    while True:
                                        ...
                                        while d1(po,U) != 0:
                                            clark = 0
                                            po.coord[i] = po.coord[i] + s*d1(po,U)
                                        for side in range(-1,2,2):
                                            ...
                                            pi.coord[i] -= s*1
                                            while True:
                                                pb.coord[dT] += side*d1(pi,U)
                                                pi.coord[dT] += side*d1(pi,U)
                                                if d1(pi,U) == 0 and d1(pb,U) == 0:
                                                    if back == 1:
                                                ...
                                                if d1(pb,U) != 0:
                                                    while d1(pb,U) != 0:
                                                        pb.coord[dT] -= side*d1(pb,U)
                                                        pi.coord[dT] -= side*d1(pb,U)
                                                    if back == 1:
...
for i in range(0,1):
    ...
    # # B1 = Box(2)
    # # B1.Borders = [(2,10),(5,13)]

    # # B2 = Box(2)
    # # B2.Borders = [(7,16),(3,15)]
    ...
    # B1 = Box(3)
    # B1.Borders = [[5,15],[2,11],[9,15]]

    # B2 = Box(3)
    # B2.Borders = [[5,12],[5,9],[5,18]]

    # B3 = Box(3)
    # B3.Borders = [[10,18],[1,9],[1,17]]
    ...
    # result = walkBox(p,S) + walkBox(p1,S) + walkBox(p2,S) + walkBox(p3,S) + walkBox(p4,S)  + walkBox(p5,S) + walkBox(p6,S) + walkBox(p7,S) + walkBox(p8,S) + walkBox(p9,S) 

    # i = 0
    # while i >= 0 and i < len(result):
    #     y = i+1
    #     while y> i and y<len(result):
    #         if result[y].samePoint(result[i]):
    ...
    # # mix = recon(copy.deepcopy(result),S)
    # # for i in mix:
    # #     pass
    # # print(len(mix[2]))
    # # for i in mix[1][0]:
    # #     i.plot3D(ax,0)
    # #     if (-1 in i.pl or 1 in i.pl):
    # #         pass
    # # #p.plot3D(ax,1)
    # # S.plot3D(ax,1)
    ...
    # B1 = Box(8)
    # B1.Borders = [[0,11],[5,15],[5,15],[5,15],[5,15],[5,15],[5,15],[5,15]]

    # B2 = Box(8)
    # B2.Borders = [[10,18],[6,13],[6,13],[6,13],[6,13],[6,13],[6,13],[6,13]]
    ...
    # p = point(8)
    # p.coord = [4,10,10,10,10,10,10,10]

    # p1 = point(8)
    # p1.coord = [15,10,10,10,10,10,10,10]
